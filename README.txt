...
We recommend that you first unzip the file "FonaDyn Handbook.pdf" and read the chapter "Software Setup". 
...
Use the latest version - at this writing, it is 3.10.3.
...
6) Move the folders FonaDyn and FonaDynTools from this ZIP file to that folder. 
...
This will open the FonaDyn main window.
To test FonaDyn, unzip the file test_Voice_EGG.wav, and put it in the directory 
displayed by FonaDyn as "Output Directory". 
Select "Source: From file" and browse to that file. 
Then press "> START". 
