...
%  The argument nClusters is used only with 'maxCluster' and 'Cluster <N>'
...
% 			var cHue;
% 
% 			// map crest factor 1.0 (+0 dB) ... <4 (+12 dB) to cyan...green...red
...
% 			// map dEGGmax 0.1 ... 1.0 to purple...green
